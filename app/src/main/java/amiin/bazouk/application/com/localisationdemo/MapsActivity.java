...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void getSellMarkers() {
        MarkerSold markerSold1 = new MarkerSold(new User("A",0,0),null,new LatLng(32.077794, 34.781362 ),3,3);
        sellMarkers.add(markerSold1);

        MarkerSold markerSold2 = new MarkerSold(new User("B",0,0),null,new LatLng(32.075612, 34.781652 ),8,4);
        sellMarkers.add(markerSold2);

        MarkerSold markerSold3 = new MarkerSold(new User("C",0,0),null,new LatLng(32.077503, 34.782296 ),7,5);
        sellMarkers.add(markerSold3);

        MarkerSold markerSold4 = new MarkerSold(new User("D",0,0),null,new LatLng(51.532293, -0.106230 ),7,5);
        sellMarkers.add(markerSold4);

        MarkerSold markerSold5 = new MarkerSold(new User("E",0,0),null,new LatLng(51.499895, -0.134211),7,5);
    ...
    private void removeMarker() {
        for(MarkerSold sellMarker: sellMarkers)
        {
            if(sellMarker.getOwnerMarker().equals(user.getUsername()))
            {
